//this program is on page and it uses malloc and free to create a binary tree/linked list. 
//page 300 and onwards in HFC
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
    ...
    do {
        ...
        while (1) {
            if (yes_no(current->question))
            {
                ...
                //Make th no-node a copy of this question */
